    ...
    try {
      ...
      for (let i = 0; i < questions.length; i++) {
        ...
        const res = await fetch(`${BACKEND}/predict`, {
          ...
          body: JSON.stringify({ text: r.text, phase: 'post_run' }),
        });
        ...
        {showResults ? (
          <div className="space-y-8">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-bold">Your Post-Run Analysis</h2>
              <button
                onClick={() => {
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              Answer these questions to help track your mood after running.
            </p>
